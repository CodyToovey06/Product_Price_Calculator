...
from product_console import load_products
...
class ProductApp(App):
    ...
    def __init__(self, **kwargs):
        ...
        # self.guitars = [("Gibson L-5 CES", 1922, 16035.40),
        #                 ("Line 6 JTV-59", 2010, 1512.9),
        #                 ("Ukulele", 2017, 99.95),
        #                 ("McPherson Sable", 2023, 5800.5)]
    ...
    def create_widgets(self):
        ...
        self.status_text = f"Total price {DEFAULT_PRICE} "
